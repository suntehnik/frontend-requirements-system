      ...
      <v-row>
        <v-col cols="12">
          <div class="d-flex justify-space-between align-center mb-4">
            ...
            <div>
              <v-btn color="primary" prepend-icon="mdi-pencil" class="mr-2" @click="editEpic">
                Редактировать
              </v-btn>
              <v-btn color="success" prepend-icon="mdi-plus" @click="addUserStory">
                Добавить историю
              </v-btn>
            </div>
          </div>
        ...
        <v-col cols="12" md="8">
          ...
          <v-card>
            <v-card-title>
              ...
              <v-spacer />
              <v-btn color="primary" size="small" prepend-icon="mdi-plus" @click="addUserStory">
                Добавить историю
              </v-btn>
            </v-card-title>
            <v-card-text>
